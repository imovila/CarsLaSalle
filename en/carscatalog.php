                            ...
                            <div class="clear"></div>
                                ...
                                <script>
                                    function getModel(val) {
                                        ...
                                        xmlhttp.open("GET", "carscatalog.php?makeid=" + val, true);
                                        xmlhttp.send();
                                    }
                                </script>
            ...
            <div class="main_catalog">
                <div class="top_catalog_box">
                    <div class="switch">
                        ...
                        <a href="carscataloggrid.php?crt=<?php echo urlencode($crt); ?>" class="list_view"></a>
                    </div>
                    ...
                    <form action="carscatalog.php?crt=<?php echo urlencode($crt); ?>" method="post">
                            ...
                            foreach ($cars as $key => $val){
                                echo "<li>
                                        ...
                                        <div class='catalog_desc'>
                                            <div class='location'>Status: ".Dict::ReadDicData('diccarstatus', $val['status'])."</div>
                                            <div class='title_box'>
                                            ...
                                            <div class='clear'></div>
                                            <div class='grey_area'>
                                                <span>Registration ".$val['year']."</span>
                                                <span>".Dict::ReadDicData('dicengine', $val['engine'])." ".Dict::ReadDicData('dicfuel', $val['fuel'])."</span>
                                                <span>Doors ".$val['doors']."</span>
                                                <span>Seats ".$val['seats']."</span>
                                                <span>Body ".Dict::ReadDicData('dicbody', $val['body'])."</span>
                                                <span>".$val['mileage']." Km</span>
                                            </div>
                                            <a href='carpage.php?carid=".urlencode($val['carid'])."&crt=".urlencode($crt)."&p=c' class='more markered'>View details</a>
                                        </div>
                                    </li>";
                            }
                        }
