            ...
            <div class="content">
                <div class="wrapper_1">
                    <div class="slider_wrapper">
                        <h2><strong>Last<span style="color: #ff3300"> 10</span></strong> Added</h2>
                            ...
                            <div class="slider slider_1">
                                <?php
                                        ...
                                        foreach ($cars as $key => $val){
                                            $carid = $val['carid'];                                     
                                            echo "<div class=\"slide\"><a href=\"carpage.php?carid=$carid\">".
                                                 ...
                                                 ."<p class=\"desc\"><span><strong>Miles: </strong>".$val['mileage']."</span><span><strong>Engine: </strong>"
                    ...
                    <div class="search_auto_wrapper">
                        ...
                        <form method="post" action="carscatalog.php">
                            <div class="search_auto">
                                ...
                                <script>
                                    function getModel(val) {
                                        ...
                                        xmlhttp.open("GET", "main.php?makeid=" + val, true);
                                        xmlhttp.send();
                                    }
                                </script>
                                ...
                                <!--onclick="return verifySelectedOption();"-->
                                <div class="clear"></div>
                            </div>
                        </form>
                        ...
                        <?php
                            ...
                            foreach ($cars as $key => $val){
                                ...
                                echo "<div class=\"slide\"><a href=\"#\"><img src=\"data:image/jpeg;base64,".base64_encode(Car::ReadPic($carid))."\" /></a>"
                                     ."<div class=\"description\">Registration ".$val['year']."<br />Engine ".Dict::ReadDicData('dicengine', $val['engine'])
                                     ."<br />Mileage ".$val['mileage']." km</div><div class=\"title\">".Dict::ReadDicData('dicmake', $val['make'])." "
                ...
                <div class="wrapper_2">
                    <div>
                        <div class="video_box">
                            <h2><strong>Video</strong> luxury cars</h2>
                            <div class="post_block">
                                ...
                                <h5><a href="https://goo.gl/A9o5SU">Rolls-Royce Phantom. The ultra-luxury benchmark.</a></h5>
                                <div class="post">
                                    <p>02 min 29 sec</p>
                                </div>
                            </div>
                            <div class="post_block">
                                ...
                                <h5><a href="https://goo.gl/7orGoh">Mercedes-Maybach. Unmistakable presence.</a></h5>
                                <div class="post">
                                    <p>59 sec</p>
                                </div>
                            </div>
                            <div class="post_block">
                                ...
                                <h5><a href="https://goo.gl/245b9m">Bugatti Veyron. Super Sport versions.</a></h5>
                                <div class="post">
                                    <p>55 sec</p>
                                </div>
                            </div>
                            <div class="post_block last">
                                ...
                                <h5><a href="https://goo.gl/rWuQU">McLaren - Challenge The Impossible</a></h5>
                                <div class="post">
                                    <p>01 min 05 sec</p>
                                </div>
                            </div>
