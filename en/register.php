<?php
    ...
    if (isset($_POST['submit'])){
        if (isset($_POST['term'])){
            ...
            $msg = "0Please accept the terms and conditions";
            ...
            <div class="content">
                ...
                <form method="post" action="#">
                    <div class="sell_box sell_box_5">
                        <br/>
                        <h2><strong>Create</strong> your <strong>CarsLasalle</strong> account</h2>
                        <p align="center" style="margin-bottom: 15px;">Please fill in this form to create an account.</p>
