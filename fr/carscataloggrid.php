...
<head>
    ...
    <!-- Page Title -->
    <title>Grille du catalogue</title>
        ...
        <div class="content">
            ...
            <div class="main_wrapper">
                ...
                <div class="catalog_sidebar">
                    ...
                    <form method="post" action="carscataloggrid.php">
                        <div class="search_auto">
                            ...
                            <script>
                                function getModel(val) {
                                    ...
                                    xmlhttp.open("GET", "carscataloggrid.php?makeid=" + val, true);
                                    xmlhttp.send();
                                }
                            </script>
            ...
            <div class="main_catalog">
                <div class="top_catalog_box">
                    <div class="switch">
                        <a href="carscatalog.php?crt=<?php echo urlencode($crt); ?>" class="table_view"></a>
                    ...
                    <form action="carscataloggrid.php?crt=<?php echo urlencode($crt); ?>" method="post">
                    ...
                    <?php
                        ...
                        if (count($cars) > 0){
                            ...
                            foreach ($cars as $key => $val){
                                ...
                                echo "<a href='carpage.php?carid=".urlencode($val['carid'])."&crt=".urlencode($crt)."&p=g'><img height='164' width='213' src=\"data:image/jpeg;base64,".base64_encode(Car::ReadPic($val['carid']))."\" alt=''/>     <div class='description'>Immatriculation ".$val['year']."<br/>".Dict::ReadDicData('dicengine', $val['engine'])." ".Dict::ReadDicData('dicfuel', $val['fuel'])."<br/>Carrosserie ".Dict::ReadDicData('dicbody', $val['body']);
                                        if ($val['mileage'] != 0) echo "<br/>".$val['mileage']." Km";
                                        if ($val['oldprice'] != 0) echo "<br/><font color='red'>Ancien prix ".$val['oldprice']."</font>";
