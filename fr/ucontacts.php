<?php 
    ...
    if (isset($_POST['submit'])){
        $mes = new Message($_POST['name'],$_POST['email'],$_POST['tel'],$_POST['message'], $_SESSION['uid']);
        $msg = $mes->Set();
        unset($_POST['submit']);
    }
?>
        ...
        <div class="content">
            <div class="main_wrapper">
                ...
                <div class="contacts_box">
                    <div class="left">
                        <h3><strong>Détails</strong> du contact</h3>
                        <div class="addr detail">2000 Rue Sainte-Catherine O, Montréal QC H3H 2T3</div>
                ...
                <div class="contact_form">
                    <h2><strong>Écrivez</strong>-nous</h2>
                    ...
                    <form method="post" action="#">
                        ...
                        <div class="sell_submit_wrapper">
                            <input type="submit" name="submit" value="soumettre" class="sell_submit" />
                        </div>
                    </form>
