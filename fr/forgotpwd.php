            ...
            <div class="content">
                ...
                <form action="#" method="post">
                    <div class="main_wrapper">
                        <h1><strong>Réinitialisez</strong> votre mot de passe</h1>
                        <div class="sell_box sell_box_1">
                            ...
                            <div class="input_wrapper large">
                                <label><span>* </span><strong>Nouveau mot de passe:</strong></label>
                    ...
                    <div class="sell_submit_wrapper">
                        <input type="submit" name="submit" value="Réinitialiser" class="sell_submit" />
                        <div class="clear"></div>
                    </div>
                </form>
